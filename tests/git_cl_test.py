...
class CMDFormatTestCase(unittest.TestCase):
    ...
    def testLitTemplateFormatter(self, mock_call, mock_solution_path):
        ...
        self.assertEqual(
            0,
            git_cl._RunLitTemplateFormatter(
    ...
    def testRunMetricsXMLFormatSkipIfPresubmit(self, find_top_dir):
        ...
        return_value = git_cl._RunMetricsXMLFormat(
...
+const html  =  `<div></div>`;
    ...
    @mock.patch("git_cl._RunClangFormatDiff", return_value=0)
    @mock.patch("git_cl.settings.GetFormatJs", return_value=False)
...
class TestRuffBatchIntegration(unittest.TestCase):
    ...
    def test_ruff_batch_success(self, mock_communicate, mock_supported):
        ...
        self.assertEqual(
            ["vpython3", git_cl._GetRuffChromiumPath(), "--batch"], call_args[0]
        )
        self.assertEqual(
