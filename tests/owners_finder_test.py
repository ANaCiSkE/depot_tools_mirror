...
class OwnersFinderTests(_BaseTestCase):
    ...
    def test_select(self, mockScoreOwners):
        ...
        self.assertEqual(
            finder.output, ["Selected: " + john, "Deselected: " + darin]
        )
        ...
        self.assertEqual(
            finder.output, ["Selected: " + darin, "Deselected: " + john]
        )
        ...
        self.assertEqual(
            finder.output, ["Selected: " + brett, "Deselected: " + ben]
        )
    ...
    def test_deselect(self, mockScoreOwners):
        ...
        self.assertEqual(
            finder.output, ["Deselected: " + john, "Selected: " + darin]
        )
    ...
    def test_print_file_info(self):
        ...
        self.assertEqual(
            finder.output, ["chrome/renderer/gpu/gpu_channel_host.h [5]"]
        )
