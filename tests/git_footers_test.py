...
"""
    ...
    def testFootersBasic(self):
        ...
        self.assertEqual(
            git_footers.parse_footers(
                self._message + self._position_footer + self._position_footer
            ),
        ...
        self.assertEqual(
            ...
            {"Bug": [""], "Cr-Commit-Position": [self._position]},
        )
    ...
    def testAddFooterChangeId(self):
        with self.assertRaises(AssertionError):
            git_footers.add_footer_change_id(
                "Already has\n\nChange-Id: Ixxx", "Izzz"
            )
    ...
    def testAddFooter(self):
        ...
        self.assertEqual(
            git_footers.add_footer(
                "Top\n\nSome: footer", "Key", "value", after_keys=["Any"]
            ),
            "Top\n\nSome: footer\nKey: value",
        )
        ...
        self.assertEqual(
            git_footers.add_footer(
                "Top\n\nSome: footer", "Key", "value", after_keys=["Some"]
            ),
            "Top\n\nSome: footer\nKey: value",
        )
