...
class GClientSmokeCipd(gclient_smoketest_base.GClientSmokeBase):
    ...
    def testConvertGitToCipd(self):
        ...
        tree = self.mangle_git_tree(
            ("repo_13@1", "src"), ("repo_12@1", "src/repo12")
        )
        self.assertTree(tree)
    ...
    def testRevInfo(self):
        ...
        out = (
            ...
            % {
                "base": self.git_base,
                "instance_url1": CHROME_INFRA_URL
                + "/package0@package0-fake-tag:1.0",
                "instance_url2": CHROME_INFRA_URL
                + "/package0/${platform}@package0/${platform}-fake-tag:1.0",
                "instance_url3": CHROME_INFRA_URL
    ...
    def testRevInfoActual(self):
        ...
        out = (
            ...
            % {
                ...
                "instance_url2": CHROME_INFRA_URL
                + "/p/package0/platform-expanded-test-only"
