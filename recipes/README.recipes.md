...
#### **class [BotUpdateApi](/recipes/recipe_modules/bot_update/api.py#286)([RecipeApi][recipe_engine/wkt/RecipeApi]):**

&mdash; **def [\_\_call\_\_](/recipes/recipe_modules/bot_update/api.py#295)(self, name, cmd, \*\*kwargs):**
...
&mdash; **def [bundle\_create](/recipes/recipe_modules/git/api.py#411)(self, bundle_path, rev_list_args=None, \*\*kwargs):**
...
&mdash; **def [config\_get](/recipes/recipe_modules/git/api.py#380)(self, prop_name, \*\*kwargs):**
...
&mdash; **def [get\_remote\_url](/recipes/recipe_modules/git/api.py#399)(self, remote_name=None, \*\*kwargs):**
...
&mdash; **def [get\_timestamp](/recipes/recipe_modules/git/api.py#351)(self, commit='HEAD', test_data=None, \*\*kwargs):**

Find and return the timestamp of the given commit.

&mdash; **def [ls\_remote](/recipes/recipe_modules/git/api.py#492)(self, url, ref, name=None, \*\*kwargs):**
...
&mdash; **def [new\_branch](/recipes/recipe_modules/git/api.py#424)(self, branch, name=None, upstream=None, upstream_current=False, \*\*kwargs):**
...
&mdash; **def [number](/recipes/recipe_modules/git/api.py#455)(self, commitrefs=None, test_values=None):**
...
&mdash; **def [rebase](/recipes/recipe_modules/git/api.py#360)(self, name_prefix, branch, dir_path, remote_name=None, \*\*kwargs):**
...
#### **class [TryserverApi](/recipes/recipe_modules/tryserver/api.py#49)([RecipeApi][recipe_engine/wkt/RecipeApi]):**

&emsp; **@property**<br>&mdash; **def [constants](/recipes/recipe_modules/tryserver/api.py#73)(self):**

&emsp; **@property**<br>&mdash; **def [gerrit\_change](/recipes/recipe_modules/tryserver/api.py#78)(self):**

Returns current gerrit change, if there is exactly one.

Returns a self.m.buildbucket.common_pb2.GerritChange or None.

&emsp; **@property**<br>&mdash; **def [gerrit\_change\_fetch\_ref](/recipes/recipe_modules/tryserver/api.py#180)(self):**

Returns gerrit patch ref, e.g. "refs/heads/45/12345/6, or None.

Populated iff gerrit_change is populated.

&emsp; **@property**<br>&mdash; **def [gerrit\_change\_number](/recipes/recipe_modules/tryserver/api.py#198)(self):**
...
&emsp; **@property**<br>&mdash; **def [gerrit\_change\_owner](/recipes/recipe_modules/tryserver/api.py#110)(self):**
...
&emsp; **@property**<br>&mdash; **def [gerrit\_change\_repo\_host](/recipes/recipe_modules/tryserver/api.py#94)(self):**

Returns the host of the gitiles repo of the current Gerrit CL.

Populated iff gerrit_change is populated.

&emsp; **@property**<br>&mdash; **def [gerrit\_change\_repo\_project](/recipes/recipe_modules/tryserver/api.py#102)(self):**

Returns the project of the gitiles repo of the current Gerrit CL.

Populated iff gerrit_change is populated.

&emsp; **@property**<br>&mdash; **def [gerrit\_change\_repo\_url](/recipes/recipe_modules/tryserver/api.py#86)(self):**

Returns canonical URL of the gitiles repo of the current Gerrit CL.

Populated iff gerrit_change is populated.

&emsp; **@property**<br>&mdash; **def [gerrit\_change\_review\_url](/recipes/recipe_modules/tryserver/api.py#120)(self):**

Returns the review URL for the active patchset.

&emsp; **@property**<br>&mdash; **def [gerrit\_change\_target\_ref](/recipes/recipe_modules/tryserver/api.py#189)(self):**

Returns gerrit change destination ref, e.g. "refs/heads/main".

Populated iff gerrit_change is populated.

&emsp; **@property**<br>&mdash; **def [gerrit\_patchset\_number](/recipes/recipe_modules/tryserver/api.py#210)(self):**
...
&mdash; **def [get\_change\_description](/recipes/recipe_modules/tryserver/api.py#632)(self):**

Gets the CL description.

&mdash; **def [get\_files\_affected\_by\_patch](/recipes/recipe_modules/tryserver/api.py#256)(self, patch_root, report_files_via_property=None, \*\*kwargs):**
...
&mdash; **def [get\_files\_affected\_by\_patch\_with\_submodules](/recipes/recipe_modules/tryserver/api.py#297)(self, patch_root, report_files_via_property=None, \*\*kwargs):**
...
&mdash; **def [get\_footer](/recipes/recipe_modules/tryserver/api.py#624)(self, tag, patch_text=None):**

Gets a specific tag from a CL description

&mdash; **def [get\_footers](/recipes/recipe_modules/tryserver/api.py#578)(self, patch_text=None):**
...
&mdash; **def [initialize](/recipes/recipe_modules/tryserver/api.py#64)(self):**

&emsp; **@property**<br>&mdash; **def [is\_gerrit\_issue](/recipes/recipe_modules/tryserver/api.py#227)(self):**

Returns true iff the properties exist to match a Gerrit issue.

&emsp; **@property**<br>&mdash; **def [is\_patch\_in\_git](/recipes/recipe_modules/tryserver/api.py#237)(self):**

&emsp; **@property**<br>&mdash; **def [is\_tryserver](/recipes/recipe_modules/tryserver/api.py#222)(self):**

Returns true iff we have a change to check out.

&mdash; **def [normalize\_footer\_name](/recipes/recipe_modules/tryserver/api.py#629)(self, footer):**

&mdash; **def [require\_is\_tryserver](/recipes/recipe_modules/tryserver/api.py#243)(self):**

&mdash; **def [set\_change](/recipes/recipe_modules/tryserver/api.py#637)(self, change):**
...
&mdash; **def [set\_compile\_failure\_tryjob\_result](/recipes/recipe_modules/tryserver/api.py#541)(self):**

Mark the tryjob result as a compile failure.

&mdash; **def [set\_invalid\_test\_results\_tryjob\_result](/recipes/recipe_modules/tryserver/api.py#553)(self):**
...
&mdash; **def [set\_patch\_failure\_tryjob\_result](/recipes/recipe_modules/tryserver/api.py#537)(self):**

Mark the tryjob result as failure to apply the patch.

&mdash; **def [set\_subproject\_tag](/recipes/recipe_modules/tryserver/api.py#515)(self, subproject_tag):**
...
&mdash; **def [set\_test\_expired\_tryjob\_result](/recipes/recipe_modules/tryserver/api.py#570)(self):**
...
&mdash; **def [set\_test\_failure\_tryjob\_result](/recipes/recipe_modules/tryserver/api.py#545)(self):**
...
&mdash; **def [set\_test\_timeout\_tryjob\_result](/recipes/recipe_modules/tryserver/api.py#562)(self):**
...
&emsp; **@property**<br>&mdash; **def [valid\_footers](/recipes/recipe_modules/tryserver/api.py#69)(self):**
...
[recipe_engine/recipe_modules/archive]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/d16f811d8b1a30274ec53d23765c42514aa7ba0b/README.recipes.md#recipe_modules-archive
[recipe_engine/recipe_modules/assertions]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/d16f811d8b1a30274ec53d23765c42514aa7ba0b/README.recipes.md#recipe_modules-assertions
[recipe_engine/recipe_modules/buildbucket]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/d16f811d8b1a30274ec53d23765c42514aa7ba0b/README.recipes.md#recipe_modules-buildbucket
[recipe_engine/recipe_modules/cipd]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/d16f811d8b1a30274ec53d23765c42514aa7ba0b/README.recipes.md#recipe_modules-cipd
[recipe_engine/recipe_modules/commit_position]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/d16f811d8b1a30274ec53d23765c42514aa7ba0b/README.recipes.md#recipe_modules-commit_position
[recipe_engine/recipe_modules/context]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/d16f811d8b1a30274ec53d23765c42514aa7ba0b/README.recipes.md#recipe_modules-context
[recipe_engine/recipe_modules/cq]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/d16f811d8b1a30274ec53d23765c42514aa7ba0b/README.recipes.md#recipe_modules-cq
[recipe_engine/recipe_modules/cv]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/d16f811d8b1a30274ec53d23765c42514aa7ba0b/README.recipes.md#recipe_modules-cv
[recipe_engine/recipe_modules/file]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/d16f811d8b1a30274ec53d23765c42514aa7ba0b/README.recipes.md#recipe_modules-file
[recipe_engine/recipe_modules/findings]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/d16f811d8b1a30274ec53d23765c42514aa7ba0b/README.recipes.md#recipe_modules-findings
[recipe_engine/recipe_modules/json]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/d16f811d8b1a30274ec53d23765c42514aa7ba0b/README.recipes.md#recipe_modules-json
[recipe_engine/recipe_modules/led]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/d16f811d8b1a30274ec53d23765c42514aa7ba0b/README.recipes.md#recipe_modules-led
[recipe_engine/recipe_modules/milo]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/d16f811d8b1a30274ec53d23765c42514aa7ba0b/README.recipes.md#recipe_modules-milo
[recipe_engine/recipe_modules/path]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/d16f811d8b1a30274ec53d23765c42514aa7ba0b/README.recipes.md#recipe_modules-path
[recipe_engine/recipe_modules/platform]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/d16f811d8b1a30274ec53d23765c42514aa7ba0b/README.recipes.md#recipe_modules-platform
[recipe_engine/recipe_modules/properties]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/d16f811d8b1a30274ec53d23765c42514aa7ba0b/README.recipes.md#recipe_modules-properties
[recipe_engine/recipe_modules/proto]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/d16f811d8b1a30274ec53d23765c42514aa7ba0b/README.recipes.md#recipe_modules-proto
[recipe_engine/recipe_modules/raw_io]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/d16f811d8b1a30274ec53d23765c42514aa7ba0b/README.recipes.md#recipe_modules-raw_io
[recipe_engine/recipe_modules/resultdb]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/d16f811d8b1a30274ec53d23765c42514aa7ba0b/README.recipes.md#recipe_modules-resultdb
[recipe_engine/recipe_modules/runtime]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/d16f811d8b1a30274ec53d23765c42514aa7ba0b/README.recipes.md#recipe_modules-runtime
[recipe_engine/recipe_modules/step]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/d16f811d8b1a30274ec53d23765c42514aa7ba0b/README.recipes.md#recipe_modules-step
[recipe_engine/recipe_modules/time]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/d16f811d8b1a30274ec53d23765c42514aa7ba0b/README.recipes.md#recipe_modules-time
[recipe_engine/recipe_modules/url]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/d16f811d8b1a30274ec53d23765c42514aa7ba0b/README.recipes.md#recipe_modules-url
[recipe_engine/recipe_modules/version]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/d16f811d8b1a30274ec53d23765c42514aa7ba0b/README.recipes.md#recipe_modules-version
[recipe_engine/recipe_modules/warning]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/d16f811d8b1a30274ec53d23765c42514aa7ba0b/README.recipes.md#recipe_modules-warning
[recipe_engine/wkt/RecipeApi]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/d16f811d8b1a30274ec53d23765c42514aa7ba0b/recipe_engine/recipe_api.py#439
